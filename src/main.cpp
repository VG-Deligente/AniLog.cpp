...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // =====================================================================
            ...
            sidebarBtn("Help",        HELP); // Placeholder for future help screen
            ...
            // =================================================================
                ...
                ImGui::SetWindowFontScale(1.5f); // Visually larger font for the section title
                ...
                if (ImGui::BeginTable("StatsInsights", 2, statFlags)) {
                    ...
                    auto insightRow = [](const char* label, const char* value) {
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0); ImGui::SetWindowFontScale(1.3f); ImGui::Text("%s", label);
                        ImGui::TableSetColumnIndex(1); ImGui::SetWindowFontScale(1.3f); ImGui::TextColored(ImVec4(0.4f, 1.0f, 0.6f, 1.0f), "%s", value);
                    };
                    ...
                    ImGui::EndTable();
                                    ...
                                    // After your tables, at the bottom of the Statistics tab
                    ImGui::Spacing(); ImGui::Spacing();
                    ImGui::SetWindowFontScale(1.4f);
                    ...
                    float  barW       = (canvasW - barPadding * (barCount + 1)) / barCount;
                    float  labelH     = 20.0f;
                    ...
                    for (int i = 0; i < barCount; i++) {
                        ...
                        float x0 = canvasPos.x + barPadding + i * (barW + barPadding);
                        float y0 = canvasPos.y + graphH * (1.0f - ratio);  // top of bar
                        float y1 = canvasPos.y + graphH;                    // bottom of bar
                    ...
                    // Advance cursor so ImGui knows the space is used
            ...
            // =================================================================
                ...
                ImGui::SetWindowFontScale(1.3f); // font scale for the log entries
